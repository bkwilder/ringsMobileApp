        ...
        >
          ...
          >
            <View style={styles.header}>
              <Text style={styles.headerText}>Rings</Text>
            </View>
            <View style={styles.container}>
              ...
              {this.props.rings.length ? (
                    ...
                    return (
                      ...
                      >
                        <View style={styles.ringCard}>
                          <View style={{ flex: 0.5, height: 150, width: 150 }}>
                            <Image
                              source={{ uri: ring.image }}
                              style={{
                                flex: 1,
                                height: "100%",
                                width: "100%",
                ...
                <View>
                  <Text style={styles.noRingsText}>
                    Add a new ring to your tree!
                  </Text>
                </View>
              )}
            </View>
